...
public class P665NonDecreasingArray {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(p.checkPossibility(new int[] {-1, 4, 2, 3}));
    System.out.println(p.checkPossibility(new int[] {1, 1, 3, 5, 2, 4, 9}));
    System.out.println(p.checkPossibility(new int[] {4, 2, 3}));
    System.out.println(p.checkPossibility(new int[] {2, 3, 3, 2, 4}));
  }
