 ...
 *         (Two strings are consecutive if the last character of the first
 *         string is exactly one index before the first character of the second
 *         string.)
 * 
 ...
 *         This is the lexicographically largest string possible after some
 *         number of swaps. Note:
 * 
 *         S has length at most 50. S is guaranteed to be a special binary
 *         string as defined above.
 * 
 */
public class P761SpecialBinaryString {

	public String getSpecialBinaryString(String S) {
