...
public final class In {
	...
	/**
	 * Returns true if input stream is empty (except possibly whitespace). Use this
	...
	/**
	 * Returns true if this input stream has a next line. Use this method to know
	...
	/**
	 * Returns true if this input stream has more input (including whitespace). Use
	...
	/**
	 * Reads the next token from this input stream, parses it as a {@code int}, and
	...
	/**
	 * Reads the next token from this input stream, parses it as a {@code long}, and
	 * returns the {@code long}.
	 *
	...
	/**
	 * Reads the next token from this input stream, parses it as a {@code byte}, and
	 ...
	 * (interpreting either {@code "true"} or {@code "1"} as {@code true}, and
	 * either {@code "false"} or {@code "0"} as {@code false}).
	 *
	...
	/**
	 * Reads all remaining lines from this input stream and returns them as an array
	 * of strings.
	 *
	...
	/**
	 * Reads all remaining tokens from this input stream, parses them as longs, and
